...
from gradient_reducers import StochasticUniformQuantization, SignSGDwithMajorityVoteReducerSimulation, SignSGDwithMajorityVoteReducerSimulationSignleNode
...
imagenet_vanilla_config = {
    ...
    "optimizer_weight_decay_conv":0.00001,
    "optimizer_weight_decay_other":0.00001,
    "optimizer_weight_decay_bn":0.0,
    "device" : "cuda:0",
    "data_path": "/workspace/ILSVRC2012",
