...
parser.add_argument('--warmup-mode', type=bool_string, default=True, 
...
if args.model == 'Transformer':
    ...
    model = model.LowRankRNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, 
                                rank_ratio=0.25,
